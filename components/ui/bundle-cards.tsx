    ...
    <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
      ...
      <Link href="/shop/bloomie" className="group">
        <div className="relative bg-gradient-to-br from-[#ffdde1] to-[#ee9ca7] text-white p-8 lg:p-10 overflow-hidden transition-all duration-500 hover:shadow-lg">
          ...
          <div className="absolute bottom-3 right-3 bg-gradient-to-br from-[#ffdde1] to-[#ee9ca7] text-white text-[8px] font-bold tracking-wider uppercase px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1">
